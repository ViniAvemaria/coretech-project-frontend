...
const RecoverPassword = () => {
    ...
    return (
        <div className="max-w-[425px] w-full py-12">
            <div className="flex flex-col gap-3 border border-border dark:border-border-dark rounded-lg p-8 text-primary-text dark:text-primary-text-dark bg-header dark:bg-header-dark">
